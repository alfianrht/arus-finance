...
<head>
    ...
    <script>
        ...
        const spacingScale = {
            px: '1px', 0: '0px', '0.5': 0.125, 1: 0.25, '1.5': 0.375, 2: 0.5, '2.5': 0.625, 3: 0.75, '3.5': 0.875,
            4: 1, 5: 1.25, 6: 1.5, 7: 1.75, 8: 2, 9: 2.25, 10: 2.5, 11: 2.75, 12: 3, 14: 3.5, 16: 4, 20: 5,
            24: 6, 28: 7, 32: 8, 36: 9, 40: 10, 44: 11, 48: 12, 52: 13, 56: 14, 60: 15, 64: 16, 72: 18, 80: 20, 96: 24,
        };
        ...
        window.tailwind.config = {
            theme: {
                ...
                fontSize: {
                    xs: buildFont(0.75, 1), sm: buildFont(0.875, 1.25), base: buildFont(1, 1.5), lg: buildFont(1.125, 1.75),
                    xl: buildFont(1.25, 1.75), '2xl': buildFont(1.5, 2), '3xl': buildFont(1.875, 2.25), '4xl': buildFont(2.25, 2.5),
                },
            },
        };
    </script>
    ...
    <style>
        .material-symbols-rounded {
            ...
            font-variation-settings: 'FILL' 0, 'wght' 400, 'GRAD' 0, 'opsz' 24; -webkit-font-smoothing: antialiased;
        }

        /* Global Select Fix (Remove native arrow) */
        select {
