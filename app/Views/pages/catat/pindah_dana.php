...
<div class="mx-auto max-w-xl space-y-3">
    ...
    <form method="post" action="<?= site_url('catat/keluar/pindah-dana') ?>" class="space-y-4 rounded-3xl bg-white p-5 shadow-sm">
        ...
        <div class="space-y-2">
            ...
            <textarea name="notes" rows="3" class="w-full rounded-2xl border border-zinc-100 bg-white px-4 py-3 text-sm text-zinc-950 focus:ring-2 focus:ring-lime-400" required></textarea>
        </div>
