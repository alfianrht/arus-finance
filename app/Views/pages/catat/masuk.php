...
<div class="mx-auto max-w-xl space-y-3">
    ...
    <form action="<?= esc(site_url('catat/masuk')) ?>" method="post" enctype="multipart/form-data" class="">
        <?= csrf_field() ?>
        ...
        <div class="space-y-2">
            ...
            <select name="category_id" class="h-12 w-full rounded-2xl border border-zinc-100 bg-white px-4 text-sm text-zinc-950 focus:ring-2 focus:ring-lime-400" required>
