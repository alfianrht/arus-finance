...
<div class="mx-auto max-w-xl space-y-3">
    ...
    <form class="space-y-4 rounded-3xl bg-white p-5 shadow-sm">
        ...
        <div class="rounded-3xl bg-zinc-50 p-5 text-center">
            ...
            <input type="text" value="Rp 0" class="mt-3 w-full border-0 bg-transparent text-center text-4xl font-semibold tracking-tight text-zinc-950 outline-none">
        ...
        <div class="space-y-2">
            ...
            <div class="flex flex-wrap gap-2">
                <span class="bg-lime-400 text-zinc-950 rounded-full px-3 py-2 text-sm font-medium">Honor</span>
        ...
        <div class="space-y-2">
            ...
            <select class="h-12 w-full rounded-2xl border border-zinc-100 bg-white px-4 text-sm text-zinc-950 focus:ring-2 focus:ring-lime-400">
                ...
                <?php foreach ($receivers as $receiver): ?>
                    <option><?= esc($receiver['name']) ?> (<?= esc($receiver['type'] ?? 'Lainnya') ?>)</option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="space-y-2">
            ...
            <input type="text" value="<?= date('d M Y') ?>" class="h-12 w-full rounded-2xl border border-zinc-100 bg-white px-4 text-sm text-zinc-950 focus:ring-2 focus:ring-lime-400">
        </div>

        <div class="space-y-2">
            <label class="text-sm font-medium text-zinc-700">Keterangan / Periode</label>
            <textarea rows="3" class="w-full rounded-2xl border border-zinc-100 bg-white px-4 py-3 text-sm text-zinc-950 focus:ring-2 focus:ring-lime-400" placeholder="Misal: Gaji bulan Mei 2026 atau Honor narasumber seminar..."></textarea>
        </div>
